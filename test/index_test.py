...
class TestHasManyThroughMiniProj(unittest.TestCase):
    ...
    dinner_party_1 = DinnerParty("Your parent's friend's")
    ...
    global recipe_1
    recipe_1 = Recipe("Disaster", dinner_party_1)
    global recipe_2
    recipe_2 = Recipe("Punch", dinner_party_2)
    global recipe_3
    recipe_3 = Recipe("Cookies", dinner_party_3)
    global recipe_4
    recipe_4 = Recipe("Punch", dinner_party_3)
    global recipe_5
    recipe_5 = Recipe("Cookies", dinner_party_2)
    global recipe_6
    recipe_6 = Recipe("Punch", dinner_party_1)
    global review_1
    ...
    def test_guest_class_methods(self):
        self.assertItemsEqual(Guest._all, [guest_1, guest_2, guest_3])
    ...
    def test_guest_instance_methods(self):
        ...
        self.assertEqual(len(guest_1.review_recipe(recipe_1, 2, "The disaster just wasn't disastrous enough!")), 4)
    ...
    def test_invite_instance_methods(self):
        self.assertEqual(invite_1.rsvp(invite_1, True), True)
    ...
    def test_dinner_party_class_methods(self):
        self.assertItemsEqual(DinnerParty._all, [dinner_party_1, dinner_party_2, dinner_party_3])
    ...
    def test_dinner_party_instance_methods(self):
        self.assertItemsEqual(dinner_party_1.reviews(), [review_1, review_2, review_3])
        self.assertItemsEqual(dinner_party_1.recipes(), [recipe_1, recipe_6])
        self.assertEqual(dinner_party_1.recipe_count(), 2)
    ...
    def test_review_class_methods(self):
        self.assertItemsEqual(Review._all, [review_1, review_2, review_3, review_4, review_5, review_6, review_7, review_8, review_9])
        self.assertItemsEqual(Review.all(), [review_1, review_2, review_3, review_4, review_5, review_6, review_7, review_8, review_9])
    ...
    def test_recipe_class_methods(self):
        self.assertItemsEqual(Recipe._all, [recipe_1, recipe_2, recipe_3, recipe_4, recipe_5, recipe_6])
        ...
        self.assertItemsEqual(Recipe.bottom_three(), [recipe_1, recipe_2, recipe_3])
